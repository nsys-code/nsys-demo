...
@OpenAPIDefinition(
		info = @Info(
				title = "Nsys Demo REST API",
				version = "1.0",
				description = "Nsys Demo RESTful Service",
		...
		tags = {
				@Tag(name = "Nsys Demo", description = "Nsys Demo API")
		},
		servers = @Server(url = "/api/demo/v1")
)
@Path("/")
...
public class DemoRestServiceImpl implements DemoRestService {
	...
	@Operation(
			tags = { "Nsys Demo" },
			operationId = "/api/demo/v1/getStatus",
