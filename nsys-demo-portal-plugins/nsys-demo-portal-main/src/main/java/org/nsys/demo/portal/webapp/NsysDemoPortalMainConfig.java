/* Copyright 2012, 2020 Nsys.org - Tomas Hrdlicka <tomas@hrdlicka.co.uk>. All rights reserved.
 */
...
public class NsysDemoPortalMainConfig extends AbstractPortalConfig {
	...
	protected String getCopyrightHtml() {
		String html = "Copyright &copy; 2020 <a href=\"http://tomas.hrdlicka.co.uk\" title=\"Tomas Xboot Hrdlicka\">Tomas Hrdlicka</a>";
		return html;
	}
}